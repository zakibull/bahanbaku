...
<div class="leftmenu">
  <ul class="nav nav-tabs nav-stacked">
    ...
    <li class="dropdown"><a href="#"><span class="icon-th-list"></span> Data Master</a>
      <ul>
      <li>
        <li><a href="?cat=sekretaris&page=quantity">Perencaan Kebutuhan</a></li>        
      </ul>
    </li>        
    <li class="dropdown"><a href="#"><span class="icon-pencil"></span> Laporan</a>
      <ul>       
       <li><a href="?cat=sekretaris&page=eoq">Economic Order Interval</a></li>
   ...
   <!--MENU PIMPINAN-->
    ...
    <li class="dropdown"><a href="#"><span class="icon-pencil"></span> Laporan</a>
      <ul>       
        <li><a href="?cat=pimpinan&page=eoq">Economic Order Interval</a></li> 
